...
## Project Structure
    ...
    ├── testapiautosetting_127278  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127278`
...
2. Clone this repo and `cd testapiautosetting_127278`
